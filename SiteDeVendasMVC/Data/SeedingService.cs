...
using SiteDeVendasMVC.Models.Enums;

namespace SiteDeVendasMVC.Data
{
    public class SeedingService
    {
        private SiteDeVendasMVCContext _context;

        public SeedingService(SiteDeVendasMVCContext context)
        {
            _context = context;
        }
